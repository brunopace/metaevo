...
ve = [[[[1 if (e==0 and a==0 and x==0 and v==1) else 0 for e in range(L)] for a in range(L)] for x in range(L)] for v in range(L)]
...
def fraction(v0):
    ...
    fobj = open('polynomialA1.txt', 'a')
    fobj.write(q1)
    fobj.close()

    fobj = open('polynomialA2.txt', 'a')
    fobj.write(q2)
    fobj.close()
    ...
    fobj = open('polynomialB1.txt', 'a')
    fobj.write(q1)
    fobj.close()

    fobj = open('polynomialB2.txt', 'a')
    fobj.write(q2)
    fobj.close()
    ...
    fobj = open('polynomialC1.txt', 'a')
    fobj.write(q1)
    fobj.close()

    fobj = open('polynomialC2.txt', 'a')
    fobj.write(q2)
    fobj.close()
    ...
    fobj = open('polynomialD1.txt', 'a')
    fobj.write(q1)
    fobj.close()

    fobj = open('polynomialD2.txt', 'a')
    fobj.write(q2)
    fobj.close()
