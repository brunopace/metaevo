...
xis = [[[[1 if (e==0 and a==0 and x==1) else 0 for e in range(L)] for a in range(L)] for x in range(L)] for v in range(L)]
...
def fraction(v0):
    ...
    v0 = fdab('polynomialA', v0)

    v0 = kill(v0)
    
    print 'M2'
    print 'segundo polinomio:'
    v0 = fdb('polynomialB', v0)

    
    print 'M3'
    print 'terceiro polinomio:'
    v0 = fda('polynomialC', v0)
    

    print 'M4'
    print 'quarto polinomio:'
    v0 = fdb('polynomialD', v0)
